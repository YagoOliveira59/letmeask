    ...
    <div id="page-room">
      <header>
        <div className="content">
          <Link to="/">
            <img src={logoImg} alt="Letmeask" style={{ maxHeight: '52px' }} />
          </Link>
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            {user ? (
              ...
              <span>Para enviar uma pergunta, <button onClick={handleLoginRoom} style={{ maxWidth: '90px' }}>faça seu login</button>.</span>
            )}
